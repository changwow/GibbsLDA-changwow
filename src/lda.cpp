...
void show_help() {
    ...
    printf("\tlda -est -alpha <double> -beta <double> -omega <double> -rho <double> -epsilon <double> -ntopics <int> -niters <int> -savestep <int> -twords <int> -tlinks <int> -dfile <string> -lfile <string>\n");
